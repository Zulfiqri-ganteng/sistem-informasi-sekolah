...
">
    ...
    =============================== -->
            <?php if ($role === 'admin'): ?>
                ...
                <!-- Manajemen Sekolah -->
                <?php
                // Tentukan segmen mana saja yang termasuk 'Master Data Utama'
                $masterDataSegments = ['siswa', 'guru', 'kelas', 'mapel', 'jurusan'];
                $isMasterDataOpen = in_array($segment, $masterDataSegments);
                ?>
                <li>
                    <a href="#" class="dropdown-toggle <?= $isMasterDataOpen ? 'dropdown-open' : '' ?>">
                ...
                <!-- EKSTRAKURIKULER (Tambahan Baru) -->
                <li>
                    <a href="<?= smart_url('ekskul') ?>" class="menu-link <?= $segment === 'ekskul' ? 'active' : '' ?>">
                ...
                <!-- Keuangan -->
                <?php
                // Tentukan segmen mana saja yang termasuk 'Keuangan'
                $financeSegments = ['tabungan', 'laporan'];
                $isFinanceOpen = in_array($segment, $financeSegments);
                ?>
                <li>
                    <a href="#" class="dropdown-toggle <?= $isFinanceOpen ? 'dropdown-open' : '' ?>">
                ...
                <li>
                    <a href="<?= smart_url('admin/pengaturan') ?>" class="menu-link <?= $segment === 'pengaturan' ? 'active' : '' ?>">
                        <i class="fa fa-cog"></i> <span>Pengaturan Jadwal</span>
                    </a>
                </li>

                <li>
                    <?php $isLogActive = in_array($segment, ['aktivitas-log', 'error-log']); ?>
                    <a href="#" class="dropdown-toggle <?= $isLogActive ? 'dropdown-open' : '' ?>">
                        <i class="fa fa-bug"></i> <span>Log & Debug</span>
                        <span class="chevron">▾</span>
                    </a>
                    <ul class="submenu <?= $isLogActive ? 'show' : '' ?>">
                        <li><a href="<?= smart_url('admin/aktivitas-log') ?>" class="<?= $segment === 'aktivitas-log' ? 'active' : '' ?>">Log Aktivitas</a></li>
                        <li><a href="<?= smart_url('admin/error-log') ?>" class="<?= $segment === 'error-log' ? 'active' : '' ?>">Log Error</a></li>
                    </ul>
                </li>
            <?php endif; ?>
